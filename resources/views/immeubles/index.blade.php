    ...
    <table class="min-w-full text-sm">
        <thead class="bg-gray-50 border-b">
            <tr>
                ...
                <th class="text-left px-4 py-3 text-gray-500 font-medium">Adresse</th>
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-4 text-gray-600">{{ $immeuble->adresse }}</td>
                ...
                <td class="px-4 py-4 text-gray-400 col-optional">{{ $immeuble->created_at->format('d/m/Y') }}</td>
                <td class="px-4 py-4">
